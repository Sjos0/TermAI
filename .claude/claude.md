...
**Validation:** `luac5.4 -p` nos dois arquivos + verificação manual: na próxima falha real de API, conferir que `$TMPDIR/termai_api_errors.log` recebe entrada com corpo bruto, e que "Resposta incompleta" não aparece mais após falha total esgotada.
