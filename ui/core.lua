...
-- Optimization (Bolt): Fast early return for strings without ANSI escape sequences.
-- 99.9% of strings in CLI output are plain text — skip expensive gsub entirely.
