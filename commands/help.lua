...
io.write("    \27[38;5;114mconfig\27[0m     Configurações (timeout, hooks, modelos...)\n")
...
io.write("    \27[38;5;114mupdate\27[0m     Atualiza o TermAI a partir do GitHub (origin/main)\n")
io.write("    \27[38;5;114mskills\27[0m     Instala e gerencia skills do agente\n")
io.write("    \27[38;5;114mnpx\27[0m        Alias de skills (instalador de skills)\n")
io.write("    \27[38;5;114mrestart\27[0m    Solicita restart do processo TermAI\n")
...
io.write("    TermAI config       \27[90m# abre configurações\27[0m\n")
io.write("    TermAI status       \27[90m# verifica config\27[0m\n")
io.write("    TermAI models       \27[90m# gerencia modelos\27[0m\n")
io.write("    TermAI update       \27[90m# sincroniza com origin/main\27[0m\n")
io.write("    TermAI skills       \27[90m# gerencia skills\27[0m\n")
io.write("\n")
